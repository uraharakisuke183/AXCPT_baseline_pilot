...
async function experimentInit() {
  ...
  current_page = 0;
// ID приходит автоматически из URL-параметра ?id=P001
...
function instruction0RoutineBegin(snapshot) {
  return async function () {
    ...
    instruction_text.setText(instruction_pages[current_page]);
    ...
    instruction0Components.push(instruction_text);
...
function instruction6RoutineBegin(snapshot) {
      return async function () {
        ...
        instruction6Components.push(key_resp);
...
function instruction7RoutineBegin(snapshot) {
      return async function () {
        ...
        instruction7Components.push(text_3);
        instruction7Components.push(key_resp_2);
...
function instruction8RoutineBegin(snapshot) {
      return async function () {
        ...
        instruction8Components.push(text_4);
        instruction8Components.push(key_resp_3);
...
function practice_endRoutineBegin(snapshot) {
      return async function () {
        ...
        practice_endComponents.push(text_2);
        practice_endComponents.push(key_resp_4);
...
function block_breakRoutineBegin(snapshot) {
      return async function () {
        ...
        block_breakComponents.push(text);
        block_breakComponents.push(key_resp_5);
...
function block_breakRoutineEachFrame() {
      return async function () {
        ...
        if ((t >= 60)) {
            break_text.text = "\u041f\u0435\u0440\u0435\u0440\u044b\u0432 \u043e\u043a\u043e\u043d\u0447\u0435\u043d.\n\n\u041d\u0430\u0436\u043c\u0438\u0442\u0435 \u041f\u0420\u041e\u0411\u0415\u041b \u0434\u043b\u044f \u043f\u0440\u043e\u0434\u043e\u043b\u0436\u0435\u043d\u0438\u044f.";
        }
...
function questionnareRoutineEachFrame() {
      return async function () {
        ...
        opt5_is_empty = (((opt5 === null) || (opt5.toString().strip() === "")) || (opt5.toString().strip().toLowerCase() === "none"));
        if (opt5_is_empty) {
            btn5.opacity = 0;
            btn5.disabled = true;
        } else {
                ...
                if (btn2.isClicked) {
                    ...
                    if (btn3.isClicked) {
                        ...
                        if (btn4.isClicked) {
                            ...
                            if ((btn5.isClicked && (! opt5_is_empty))) {
                                psychoJS.experiment.addData("q_number", (questions_loop.thisN + 1));
                                psychoJS.experiment.addData("question", question);
